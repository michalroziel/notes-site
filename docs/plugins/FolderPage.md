...
This [[plugin]] generates [[my-notes-site/docs/index|index]] pages for folders, creating a listing page for each folder that contains multiple content [[Files]]. See [[folder and tag listings]] for more information.
