...
1. The browser opens a Quartz page and loads the HTML. The `<head>` also links to page styles (emitted to `public/[[my-notes-site/docs/index|index]].css`) and page-critical JS (emitted to `public/prescript.js`)
